...
class Elevation
  ...
  def initialize(opts={})
    @elvtn_args = {
      :path => "49.2514,19.9337|49.1848,20.0869",
      :samples => 10,
      :sensor => false
    }.merge!(opts)
  end
  ...
  def get_chart(opts={})
    ...
    chart_args = {
      ...
      # optional args
      :chtt => "Title",
	  :chts => "AA0000,14,c", # 12 == font size
	  :chxt => 'x,y',
      :chxr => '1,1200,2800', # 0 == x-axis, 1 == y-axis
      :chds => "1000,2800",
      :chxl => "0:|Elevation",
      :chxp => "0,50", # 0 == x-axis, 50 == center
      :chco => "orange",
      :chls => "6", # line thickness
...
if __FILE__ == $PROGRAM_NAME
  ...
  puts elevation.get_chart :chtt => "Z Giewontu na Rysy", :chxl => "0:|Profil trasy do pokonania"
end
